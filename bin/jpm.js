...
function showHelp() {
    ...
    const lines = [
        '',
        c.bold('JPM') + ' \u2014 ' + c.yellow('Joint Package Manager') + ' v1.0.7',
        ...
        '  ' + c.cyan('scan [--fix]') + '        Deep security & integrity audit',
        ...
        '  ' + c.cyan('why <pkg>') + '          Trace why a package is installed',
        ...
        '  ' + c.cyan('create <tmpl>') + '       Scaffold from create- template',
        '  ' + c.cyan('ship') + '               Publish package to registry',
        '  ' + c.cyan('doctor') + '             Check environment health',
        '  ' + c.cyan('link [pkg]') + '         Local package link development',
